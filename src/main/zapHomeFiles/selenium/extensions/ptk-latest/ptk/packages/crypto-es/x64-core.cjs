...
*/
var X64Word = class extends require_core.Base {
...
*/
var X64WordArray = class X64WordArray extends require_core.Base {
	...
	*/
	toX32() {
		...
		return require_core.WordArray.create(x32Words, this.sigBytes);
	}
	/**
...
//# sourceMappingURL=x64-core.cjs.map