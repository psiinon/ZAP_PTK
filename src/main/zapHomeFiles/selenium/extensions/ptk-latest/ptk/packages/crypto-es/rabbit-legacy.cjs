...
*/
var RabbitLegacyAlgo = class extends require_cipher_core.StreamCipher {
	_X;
	_C;
	_b;
	static ivSize = 64 / 32;
...
*/
const RabbitLegacy = require_cipher_core.StreamCipher._createHelper(RabbitLegacyAlgo);

//#endregion
exports.RabbitLegacy = RabbitLegacy;
exports.RabbitLegacyAlgo = RabbitLegacyAlgo;
//# sourceMappingURL=rabbit-legacy.cjs.map