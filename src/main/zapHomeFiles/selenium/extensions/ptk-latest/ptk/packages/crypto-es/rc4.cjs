...
*/
var RC4Algo = class extends require_cipher_core.StreamCipher {
...
*/
const RC4 = require_cipher_core.StreamCipher._createHelper(RC4Algo);
/**
...
*/
const RC4Drop = require_cipher_core.StreamCipher._createHelper(RC4DropAlgo);
