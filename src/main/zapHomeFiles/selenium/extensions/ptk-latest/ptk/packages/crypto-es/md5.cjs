...
* MD5 hash algorithm.
*/
var MD5Algo = class extends require_core.Hasher32 {
	_doReset() {
...
* ```
*/
const MD5 = require_core.Hasher._createHelper(MD5Algo);
/**
...
* ```
*/
const HmacMD5 = require_core.Hasher._createHmacHelper(MD5Algo);
