...
*/
var CTRGladmanMode = class extends require_cipher_core.BlockCipherMode {
...
*/
var CTRGladman = class extends require_cipher_core.BlockCipherMode {
	/** Counter for CTR Gladman mode */
	_counter;
...
//# sourceMappingURL=mode-ctr-gladman.cjs.map