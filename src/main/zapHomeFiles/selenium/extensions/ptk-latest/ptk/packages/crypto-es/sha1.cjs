...
*/
var SHA1Algo = class extends require_core.Hasher32 {
	_doReset() {
...
* ```
*/
const SHA1 = require_core.Hasher._createHelper(SHA1Algo);
/**
...
* ```
*/
const HmacSHA1 = require_core.Hasher._createHmacHelper(SHA1Algo);
