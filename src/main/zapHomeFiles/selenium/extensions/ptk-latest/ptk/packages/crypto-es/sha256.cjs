...
*/
var SHA256Algo = class extends require_core.Hasher32 {
	_doReset() {
		this._hash = new require_core.WordArray(H.slice(0));
	}
...
* ```
*/
const SHA256 = require_core.Hasher._createHelper(SHA256Algo);
/**
...
* ```
*/
const HmacSHA256 = require_core.Hasher._createHmacHelper(SHA256Algo);
