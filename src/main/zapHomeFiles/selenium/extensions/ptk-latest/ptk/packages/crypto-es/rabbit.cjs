...
*/
var RabbitAlgo = class extends require_cipher_core.StreamCipher {
	_X;
	_C;
	_b;
	static ivSize = 64 / 32;
...
*/
const Rabbit = require_cipher_core.StreamCipher._createHelper(RabbitAlgo);

//#endregion
exports.Rabbit = Rabbit;
exports.RabbitAlgo = RabbitAlgo;
//# sourceMappingURL=rabbit.cjs.map